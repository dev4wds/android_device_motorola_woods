...
* Device Tree
  -------------
```git clone https://github.com/iykequame/android_device_motorola_woods -b LOS-15 device/motorola/woods ```
...
* Vendor 
  --------
```git clone https://github.com/iykequame/android_vendor_motorola_woods vendor/motorola/woods ```
