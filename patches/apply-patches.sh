...
cd ../..
cd frameworks/base
git apply -v ../../device/moto/woods/patches/0002-frameworks_base.patch
cd ../..
cd frameworks/native
git apply -v ../../device/moto/woods/patches/0003-frameworks_native.patch
cd ../..
cd system/netd
git apply -v ../../device/moto/woods/patches/0004-system_netd.patch
cd ../..
cd system/core
